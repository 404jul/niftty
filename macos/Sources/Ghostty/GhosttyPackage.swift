...
extension Ghostty {
    ...
    static let userNotificationCategory = "com.niftty.app.userNotification"

    // The user notification "Show" action
    static let userNotificationActionShow = "com.niftty.app.userNotification.Show"
}
...
extension Notification.Name {
    ...
    static let ghosttyConfigDidChange = Notification.Name("com.niftty.app.configDidChange")
    static let GhosttyConfigChangeKey = ghosttyConfigDidChange.rawValue

    /// Color change. Object is the surface changing.
    static let ghosttyColorDidChange = Notification.Name("com.niftty.app.colorDidChange")
    static let GhosttyColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("com.niftty.app.moveTab")
    static let GhosttyMoveTabKey = ghosttyMoveTab.rawValue

    /// Close tab
    static let ghosttyCloseTab = Notification.Name("com.niftty.app.closeTab")

    /// Close other tabs
    static let ghosttyCloseOtherTabs = Notification.Name("com.niftty.app.closeOtherTabs")

    /// Close tabs to the right of the focused tab
    static let ghosttyCloseTabsOnTheRight = Notification.Name("com.niftty.app.closeTabsOnTheRight")

    /// Close window
    static let ghosttyCloseWindow = Notification.Name("com.niftty.app.closeWindow")

    /// Resize the window to a default size.
    static let ghosttyResetWindowSize = Notification.Name("com.niftty.app.resetWindowSize")

    /// Ring the bell
    static let ghosttyBellDidRing = Notification.Name("com.niftty.app.bellDidRing")

    /// The active selection changed
    static let ghosttySelectionDidChange = Notification.Name("com.niftty.app.selectionDidChange")

    /// Readonly mode changed
    static let ghosttyDidChangeReadonly = Notification.Name("com.niftty.app.didChangeReadonly")
    static let ReadonlyKey = ghosttyDidChangeReadonly.rawValue + ".readonly"
    static let ghosttyCommandPaletteDidToggle = Notification.Name("com.niftty.app.commandPaletteDidToggle")

    /// Toggle maximize of current window
    static let ghosttyMaximizeDidToggle = Notification.Name("com.niftty.app.maximizeDidToggle")

    /// Notification sent when scrollbar updates
    static let ghosttyDidUpdateScrollbar = Notification.Name("com.niftty.app.didUpdateScrollbar")
...
extension Ghostty.Notification {
    ...
    static let NewSurfaceConfigKey = "com.niftty.app.newSurfaceConfig"

    /// Posted when a new split is requested. The sending object will be the surface that had focus. The
    /// userdata has one key "direction" with the direction to split to.
    static let ghosttyNewSplit = Notification.Name("com.niftty.app.newSplit")

    /// Close the calling surface.
    static let ghosttyCloseSurface = Notification.Name("com.niftty.app.closeSurface")

    /// Focus previous/next split. Has a SplitFocusDirection in the userinfo.
    static let ghosttyFocusSplit = Notification.Name("com.niftty.app.focusSplit")
    static let SplitDirectionKey = ghosttyFocusSplit.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyGotoTab = Notification.Name("com.niftty.app.gotoTab")
    static let GotoTabKey = ghosttyGotoTab.rawValue

    /// New tab. Has base surface config requested in userinfo.
    static let ghosttyNewTab = Notification.Name("com.niftty.app.newTab")

    /// New window. Has base surface config requested in userinfo.
    static let ghosttyNewWindow = Notification.Name("com.niftty.app.newWindow")

    /// Present terminal. Bring the surface's window to focus without activating the app.
    static let ghosttyPresentTerminal = Notification.Name("com.niftty.app.presentTerminal")
    ...
    /// Notification
    static let didReceiveInitialWindowFrame = Notification.Name("com.niftty.app.didReceiveInitialWindowFrame")
    static let FrameKey = "com.niftty.app.frame"

    /// Notification to render the inspector for a surface
    static let inspectorNeedsDisplay = Notification.Name("com.niftty.app.inspectorNeedsDisplay")

    /// Notification to show/hide the inspector
    static let didControlInspector = Notification.Name("com.niftty.app.didControlInspector")

    /// Notification sent to the active split view to resize the split.
    static let didResizeSplit = Notification.Name("com.niftty.app.didResizeSplit")
    ...
    static let didEqualizeSplits = Notification.Name("com.niftty.app.didEqualizeSplits")

    /// Notification that renderer health changed
    static let didUpdateRendererHealth = Notification.Name("com.niftty.app.didUpdateRendererHealth")

    /// Notifications related to key sequences
    static let didContinueKeySequence = Notification.Name("com.niftty.app.didContinueKeySequence")
    static let didEndKeySequence = Notification.Name("com.niftty.app.didEndKeySequence")
    static let KeySequenceKey = didContinueKeySequence.rawValue + ".key"

    /// Notifications related to key tables
    static let didChangeKeyTable = Notification.Name("com.niftty.app.didChangeKeyTable")
