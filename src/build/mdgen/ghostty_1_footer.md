...
: Where the Niftty resources can be found.
...
destinations receive logs. Niftty currently defines two destinations:
...
See GitHub issues: <https://github.com/404jul/niftty/issues>
