% GHOSTTY(1) Version @@VERSION@@ | Niftty terminal emulator

# NAME

**ghostty** - Niftty terminal emulator

# DESCRIPTION

Niftty is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of Niftty is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, Niftty is a fully standards compliant
