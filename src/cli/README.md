...
For user documentation, see the main README. For documentation of the
inherited terminal core, see the [Ghostty docs](https://ghostty.org/docs).
...
in `list_keybinds.zig` contains the help text for `niftty +list-keybinds`.
